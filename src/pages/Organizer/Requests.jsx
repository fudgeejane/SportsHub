    ...
    <section className="grid gap-4">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl shadow-slate-900/5">
        ...
        <div className="grid gap-3">
          ...
          {!system.requests.length ? <p className="rounded-2xl bg-slate-50 px-4 py-5 text-sm font-semibold text-slate-500">No join requests found.</p> : null}
        </div>
      </section>
    </section>
  )
