  ...
  return (
    <section>
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5">
        ...
        <h2 className="mt-2 text-3xl font-bold text-slate-950">Users & Roles</h2>
                  ...
                  <tr key={user.uid}>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex flex-wrap gap-2">
                        <button onClick={() => approveUser(user.uid)} className="rounded-xl bg-blue-600 px-3 py-2 font-bold text-white transition hover:bg-blue-700">
                          Approve
                        </button>
                        <button onClick={() => rejectUser(user.uid)} className="rounded-xl border border-red-200 px-3 py-2 font-bold text-red-600 transition hover:bg-red-50">
                          Reject
                        </button>
                      </div>
                    </td>
